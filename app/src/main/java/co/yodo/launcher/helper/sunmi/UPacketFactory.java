package co.yodo.launcher.helper.sunmi;
...
public class UPacketFactory {
     ...
     * @return
     */
    public static DataPacket buildPack( String receiverPackageName, DSData.DataType dataType, DataModel dataModel, String dataJson, ISendCallback callback) {
