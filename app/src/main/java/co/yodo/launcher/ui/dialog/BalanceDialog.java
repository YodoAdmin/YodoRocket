...
public class BalanceDialog extends IDialog {
    ...
    public static class Builder extends DialogBuilder {
        ...
        public Builder( Context context ) {
            ...
            // Controllers
            this.tvTodayCredits = (TextView) this.mDialog.findViewById( R.id.tvTodayCredits );
            this.tvTodayDebits  = (TextView) this.mDialog.findViewById( R.id.tvTodayDebits );
            this.tvTodayBalance = (TextView) this.mDialog.findViewById( R.id.tvTodayBalance );

            this.tvHistoryCredits = (TextView) this.mDialog.findViewById( R.id.tvHistoryCredits );
            this.tvHistoryDebits  = (TextView) this.mDialog.findViewById( R.id.tvHistoryDebits );
            this.tvHistoryBalance = (TextView) this.mDialog.findViewById( R.id.tvHistoryBalance );
        }
